...
if (isset($_POST['login'])) {
  ...
  if (password_verify($pass, $cariuser['password'])) {
    ...
    if($cariuser){
      ...
      echo '<script>alert("Username / Password Yang Anda Masukan Salah");history.go(-1);</script>';
    }
  } else {
    echo '<script>alert("Username / Password Yang Anda Masukan Salah");history.go(-1);</script>';
  }
          ...
          <div class="card-body">
            ...
            <form method="POST">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="username" placeholder="NamaPengguna" autofocus />
              </div>
              <div class="mb-3 form-password-toggle">
                <div class="d-flex justify-content-between">
                  <label class="form-label" for="password">Password</label>
                  <a href="#">
                    <small>Pastikan Untuk Selalu Ingat ID dan PW</small>
                  </a>
                </div>
              ...
              <div class="mb-3">
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="remember-me"> Ingat Selalu </label>
                </div>
              </div>
              <div class="mb-3">
